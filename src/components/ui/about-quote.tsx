        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы помогаем бизнесу говорить с клиентами напрямую — через WhatsApp, где люди действительно читают сообщения. Открываемость наших рассылок достигает 90%, потому что мы работаем честно: 3 активные сим-карты, реальная доставка и видеоотчёт после каждой рассылки.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Кафе, интернет-магазин, салон красоты или строительная компания — неважно, кто вы. Одна рассылка за 1 900 ₽ может привести новых клиентов уже сегодня.
            </p>
          </div>
        </div>
      </div>
